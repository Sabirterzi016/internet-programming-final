...
<html lang="tr">
    <head>
        ...
        <link rel="stylesheet" href="css/iltisim.css">
                ...
                <form action="iletisim-post.php" method="POST">
                    <div class="card mt-4">
                        ...
                        <?php  if(isset($_GET['success'])): ?>
                                    <div id="tbrk" class="alert-success">
                                    <strong>Tebrikler!</strong> Mesajınız başarıyla iletildi.
                                    </div>
                                <?php endif ?> <br id="bra">
                            <div class="form-group">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="adi_soyadi" placeholder="Ad Soyad" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group mb-2">
                            ...
                            <div class="text-center">
                                <input name="gonder" type="submit" value="GÖNDER" class="btn btn-info btn-block">
                            </div>
                        </div>
                    </div>
                </form>
