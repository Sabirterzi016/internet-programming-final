...
if(isset($_GET['sil'])){
    $sqlsil="DELETE FROM `uyeler` WHERE `uyeler`.`uyeId` = ?";
      ...
      <ul class="navbar-nav align-items-center">
        ...
        <li class="nav-item dropdown ms-lg-3">
          ...
          <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
            ...
            <a class="dropdown-item d-flex align-items-center" href="./../cikis.php"> <!-- xml burda kullanıldı ************* -->
                                            ...
                                            <table class="table table-hover table-dark table-striped">
                                                ...
                                                <?php while($satir = $sorgu->fetch(PDO::FETCH_ASSOC)) { ?>
                                                    <tr>
                                                        <td><?=$satir['uyeId']?></td>
                                                        <td><?=$satir['uyeAdi']?></td>
                                                        <td><?=$satir['uyeSoyadi']?></td>
                                                        <td><?=$satir['kullaniciAdi']?></td>
                                                        <td><?=$satir['kullaniciSifre']?></td>
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="detay.php?uyeId=<?=$satir['uyeId']?>" class="btn btn-success">Detay</a>
                                                                <a href="guncelle.php?uyeId=<?=$satir['uyeId']?>" class="btn btn-secondary">Güncelle</a>
                                                                <a href="?sil=<?=$satir['uyeId']?>" onclick="return confirm('Silinsin mi?') " class="btn btn-danger">Kaldır</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
