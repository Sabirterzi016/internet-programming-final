...
if(isset($_GET['sil'])){
    $sqlsil="DELETE FROM `rapor_icerik` WHERE `rapor_icerik`.`icerikId` = ?";
    $sorgusil=$baglan->prepare($sqlsil);
    $sorgusil->execute([
        $_GET['sil']
    ]);

    header('Location:iceikd.php');
...
<div class="table-settings mb-4">            
                          ...
                          <header>
                                <div class="container">
                                    <div class="row">
                                        <div class="col">
                                            <h3 class="display-3 text-center">Dip Yatırım</h3>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="btn-group">
                                                <a href="icerikd.php" class="btn btn-outline-primary">Tüm İçerikler</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>                            
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <table class="table table-hover table-dark table-striped">
                                                ...
                                                <?php while($satir = $sorgu->fetch(PDO::FETCH_ASSOC)) { ?>
                                                    <tr>
                                                        <td><?=$satir['icerikId']?></td>
                                                        <td><?=$satir['icerik_knm_adi']?></td>
                                                        <td><?=$satir['icerik']?></td>
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="icerikdetay.php?icerikId=<?=$satir['icerikId']?>" class="btn btn-success">Detay</a>
                                                                <a href="icerikguncelle.php?icerikId=<?=$satir['icerikId']?>" class="btn btn-secondary">Güncelle</a>
                                                                <a href="?sil=<?=$satir['icerikId']?>" onclick="return confirm('Silinsin mi?') " class="btn btn-danger">Kaldır</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
